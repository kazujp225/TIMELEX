...
export function BookingCalendar({
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 bg-panel">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto">
          {/* ヘッダー */}
          <header className="text-center mb-10">
            <div className="w-full max-w-[240px] h-[60px] mx-auto mb-6 flex items-center justify-center">
              <h1 className="text-3xl font-bold text-brand-600">TIMREXPLUS</h1>
            </div>
                    ...
                    {availableSlots.map((slot) => {
                      if (slot.availableStaff.length === 0) {
                        ...
                        return (
                          <div
                            ...
                            className="py-4 px-6 rounded-md border-2 border-border bg-panel-muted text-muted"
                          >
                            <div className="flex items-center justify-between">
                      ...
                      return (
                        <div key={slot.time.toISOString()} className="space-y-2">
                          <div className="text-base font-medium text-text px-2">
                            {formatDate(slot.time, "HH:mm")}
                          </div>
          ...
          {/* 選択情報と次へボタン */}
          {selectedSlot && (
            <div className="sticky bottom-0 left-0 right-0 bg-panel border-t-2 border-border p-6 -mx-4">
              <div className="max-w-7xl mx-auto px-4">
                <div className="mb-6 p-6 bg-brand-600/10 rounded-lg">
                  <p className="text-base text-muted mb-2">選択した日時</p>
