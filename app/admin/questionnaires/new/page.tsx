  ...
  return (
    <div className="max-w-7xl space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-4xl font-bold text-[#2D2D2D]">アンケート新規作成</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* 基本情報 */}
        <div className="bg-white rounded-lg border-2 p-8 space-y-6">
          <h2 className="text-2xl font-semibold text-[#2D2D2D]">基本情報</h2>
          ...
          <div>
            ...
            <Input
              ...
              className={`h-14 text-base ${errors.name ? "border-[#FF7676]" : ""}`}
            />
            {errors.name && (
          ...
          <div>
            <Label htmlFor="description" className="text-base">説明（任意）</Label>
            <Textarea
              id="description"
          ...
          <div>
            <Label htmlFor="consultation_type_id" className="text-base">対象の相談種別（任意）</Label>
            <Select
        ...
        <div className="bg-white rounded-lg border-2 p-8 space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-semibold text-[#2D2D2D]">質問設定</h2>
            <Button
              type="button"
              variant="outline"
              onClick={addQuestion}
              className="h-12 px-8 text-base transition-all duration-200 hover:scale-105 hover:shadow-md"
            >
          ...
          {questions.length === 0 ? (
            <div className="py-20 text-center border-2 border-dashed rounded-lg animate-in fade-in duration-300">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gray-100 mb-6">
                <Plus className="h-10 w-10 text-[#999999]" />
              </div>
              <p className="text-[#999999] mb-2 text-xl font-semibold">まだ質問が追加されていません</p>
        ...
        {/* アクションボタン */}
        <div className="flex gap-4 sticky bottom-0 bg-white p-6 border-t-2">
          <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
            <DialogTrigger asChild>
              <Button
                ...
                className="h-12 px-8 text-base transition-all duration-200 hover:scale-105"
              >
          ...
          <Button
            type="submit"
            className="flex-1 h-12 text-base transition-all duration-200 hover:scale-105 hover:shadow-md"
          >
            アンケートを作成
          </Button>
          <Button
            ...
            variant="outline"
            onClick={() => router.back()}
            className="flex-1 h-12 text-base transition-all duration-200 hover:scale-105"
          >
            キャンセル
          </Button>
        </div>
...
function QuestionBuilder({
  ...
  return (
    <div className="border-2 rounded-lg p-6 bg-gray-50 transition-all duration-200 hover:shadow-md">
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-1 pt-2">
          ...
          <GripVertical className="h-5 w-5 text-[#999999]" />
          <Button
            type="button"
            variant="ghost"
            size="sm"
        ...
        <div className="flex-1 space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-[#2D2D2D]">質問 {index + 1}</h3>
            <div className="flex items-center gap-2">
              <Button
                type="button"
                variant="ghost"
                onClick={() => setIsExpanded(!isExpanded)}
                className="h-10 px-4 text-base transition-all duration-200 hover:scale-105"
              >
                {isExpanded ? "折りたたむ" : "展開"}
              </Button>
              <Button
              ...
              >
                <Trash2 className="h-5 w-5 text-[#FF7676]" />
              </Button>
            </div>
          </div>
          ...
          {isExpanded && (
            <>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <Label className="text-base">質問タイプ</Label>
                  <Select
                ...
                <div className="flex items-center gap-2 pt-6">
                  <Checkbox
                    ...
                    className="h-5 w-5"
                  />
                  <Label htmlFor={`required-${question.id}`} className="text-base font-normal">
                    必須項目
                  </Label>
                </div>
              </div>
              ...
              {(question.question_type === "text" ||
                question.question_type === "textarea") && (
                <div>
                  <Label className="text-base">プレースホルダー（任意）</Label>
                  <Input
              ...
              <div>
                <Label className="text-base">ヘルプテキスト（任意）</Label>
                <Input
